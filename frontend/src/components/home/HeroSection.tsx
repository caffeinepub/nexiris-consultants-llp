  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        {/* Headline */}
        <h1
          className={`font-heading font-bold text-4xl md:text-6xl lg:text-7xl text-white leading-tight mb-6 transition-all duration-700 delay-100 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
          Trade Intelligence
        ...
        {/* Subheading */}
        <p
          className={`text-white/75 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed transition-all duration-700 delay-200 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
          Nexiris Global Pvt Ltd delivers rigorous Indian exporter verification, counterparty risk intelligence,
